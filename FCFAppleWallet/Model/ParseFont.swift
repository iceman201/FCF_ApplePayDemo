...
public enum PaymentLogo: String {
    case amazon = "\u{f000}"
    ...
    case flattr = "\u{f01a}"
    case giropay = "\u{f01b}"
    case googleWallet = "\u{f01c}"
    case googleWalletAlt = "\u{f01d}"
    case gpb = "\u{f01e}"
    case gratipay = "\u{f01f}"
    case ideal = "\u{f020}"
    case ils = "\u{f021}"
    case inr = "\u{f022}"
    case invoice = "\u{f023}"
    ...
    case interacAlt = "\u{f05f}"
    case klarna = "\u{f060}"
    case bitpay = "\u{f061}"
    case venmo = "\u{f062}"
    case visaDebit = "\u{f063}"
    case alipay = "\u{f064}"
    case dinersAlt = "\u{f065}"
    case hipercard = "\u{f066}"
    case skrillAlt = "\u{f067}"
    case shopify = "\u{f068}"
    case directDebit = "\u{f069}"
    case sodexo = "\u{f06a}"
    case bpay = "\u{f06b}"
    case contactless = "\u{f06c}"
    case contactlessAlt = "\u{f06d}"
    case eth = "\u{f06e}"
    case ltc = "\u{f06f}"
    case visaPay = "\u{f070}"
    case wechatPay = "\u{f071}"
    case amazonPay = "\u{f072}"
    case amazonPayAlt = "\u{f073}"
}
